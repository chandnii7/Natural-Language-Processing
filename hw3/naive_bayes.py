...
class IMDBReader:
    ...
    def __init__(self, data_dir):
        ...
        assert "pos" in dir_contents and "neg" in dir_contents,             "Could not find IMDB data in {}".format(data_dir)


    def get_texts(self, subset):
        """Generator function over texts in subset ('pos' or 'neg') of data
        """
        assert subset in ["pos", "neg"],             "Only data subsets 'pos' or 'neg' may be selected"
